    ...
    */
    ...
    public function createRow()
    {
        ...
        $sql = 'INSERT INTO admon(nombre, apellido, genero, correo, foto, fechaNacimiento, telefono, 
                direccion, usuario, contraseña, idEstadoUsuario, idTipoUsuario, dobleautenticacion, claverequest,intentos)
                VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
        $params = array($this->nombre, $this->apellido, $this->genero, $this->correo, $this->foto, 
                        ...
                        $hash, $this->idEstadoUsuario, $this->idTipoUsuario, 'no',0,0);
        return Database::executeRow($sql, $params);
    }
