...
<link rel="stylesheet" href="../../resources/css/usuarios_privado_estilos.css">
            ...
            <div class="row animate__animated animate__fadeInUp animate__faster">
                <div class="col-lg-8 formulario2">
                    <form class="d-flex" id='search-form' name='search-form'>
                        <input class="form-control me-2" type="search" placeholder="Buscar... {Apellido, Nombre, Usuario}" aria-label="Search" id='search' name='search'>
    ...
    dashboard_Page::sidebarTemplateMovement('administrar_clientes.js');
    ?>
