...
<html lang="es">
  ...
  <body>
    ...
    <div class="flex-column" id="container2">
        ...
        <div class="row my-4">
            <div class="col-12">
                <h1 class="tituloDato text-center px-4">Hemos detectado que tu contraseña ya 
                    es muy antigua, por favor actualiza tu clave.</h1>
            </div>
        </div>
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center flex-column">
                    ...
                    <div class="form-group">
                            <label for="txtContrasena" class="tituloCajaTextoFormulario">Constraseña actual:</label>
                            <input type="password" name="txtActualContraseña" id="txtActualContraseña" class="form-control cajaTextoFormulario widthRegister" 
                            onchange="checkContrasena('txtActualContraseña')" Required>
                        </div>
                        <div class="form-group">
                            <label for="txtContrasena" class="tituloCajaTextoFormulario">Nueva Contraseña:</label>
                            <input type="password" name="txtNuevaContraseña" id="txtNuevaContraseña" class="form-control cajaTextoFormulario widthRegister" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="txtConfirmarContraseña" id="txtConfirmarContraseña" class="form-control cajaTextoFormulario widthRegister"  
            ...
            <div class="row justify-content-center my-4">
                <div class="col-12 d-flex justify-content-center">
                    <button type="submit" class="btn boton"><span class="fas fa-check mr-3"></span>Finalizar</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <script type="text/javascript" src="../../app/controllers/dashboard/cambiar_clave.js"></script>
