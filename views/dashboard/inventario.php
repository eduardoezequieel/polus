            ...
            <div class="row animate__animated animate__fadeInUp animate__faster">
                <div class="col-lg-8 formulario2">
                    <form class="d-flex" id="search-form">
                        <input class="form-control me-2" type="search" placeholder="Buscar... {Nombre}" aria-label="Search" id="search" name="search">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <img src="../../resources/img/dashboard_img/separator.png"
                                            ...
                                            <div class="mb-3 formulario" >
                                                ...
                                                <select id="cbTalla" name="cbTalla" class="form-select" aria-label="Default select example">
                                                </select><br>
                                                <div class="mb-3">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-12 formulario">
                                            <div class="mb-3">
                                                ...
                                                <button type="submit" class="btn btn-outline-dark" id="selecciona">Guardar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
