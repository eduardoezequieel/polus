		...
		<div class="modal-content justify-content-center px-3 py-2">
			...
			<div class="textoModal px-3 pb-4 mt-2">
				<div class="row justify-content-center">
					...
					<div class="d-flex justify-content-xl-start justify-content-center mt-3 col-xl-6 col-md-12 col-sm-12 col-xs-12">
						<div>
							<button data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#cambiarAuth" class="btn btn-outline-dark tamañoBotonesMiCuenta d-flex flex-column justify-content-center align-items-center">
...
<!-- Modal para seleccionar factor de doble autenticación  -->
<div class="modal fade" id="cambiarAuth" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content justify-content-center px-3 py-2">
			<!-- Cabecera del Modal -->
			<div class="modal-header">
			...
			<div class="textoModal px-3 pb-4 mt-2">
				<div class="row px-3">
					<div class="alert alert-warning alert-dismissible fade show" role="alert">
						<h4 class="alert-heading">¡Importante!</h4>
						<p>Debes verificar tu identidad para activar/desactivar el factor de doble autenticación.</p>				
						<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
					</div>
				</div>
