...
<div class="page-content p-5" id="content">
    ...
    <div class="row justify-content-end mt-4 animate__animated animate__fadeInUp animate__faster">
        <div
            class="col-xl-6 col-md-6 col-sm-12 col-xs-12 d-flex justify-content-end align-items-right centrarContenido">
            <form>
        ...
        <div
            class="col-xl-6 col-md-6 col-sm-12 col-xs-12 d-flex justify-content-start align-items-left centrarContenido">
            <form>
