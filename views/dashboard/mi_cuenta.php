...
<div class="page-content p-5" id="content">
    ...
    <form method="post" id="info-form">
        ...
        <div class="row justify-content-end mt-4 animate__animated animate__fadeInUp animate__faster">
            <div
                class="col-xl-6 col-md-6 col-sm-12 col-xs-12 d-flex flex-column justify-content-end align-items-right centrarContenido">
                    ...
                    <input type="date" class="form-control inputMiCuenta" id="txtfechaNacimiento" name="txtfechaNacimiento" Required>
            ...
            <div
                class="col-xl-6 col-md-6 col-sm-12 col-xs-12 d-flex flex-column justify-content-start align-items-left centrarContenido">
                    ...
                    <textarea class="form-control textareaMiCuenta" id="txtDireccion"  name="txtDireccion" Required></textarea>
            </div>
        </div>
    ...
    <form method="post" id="cuenta-form">
        ...
        <div class="row justify-content-end mt-4 animate__animated animate__fadeInUp animate__faster">
            <div
                class="col-xl-6 col-md-6 col-sm-12 col-xs-12 d-flex flex-column justify-content-end align-items-right centrarContenido">
                    ...
                    <input type="text" class="form-control inputMiCuenta" id="txtUsuario" name="txtUsuario" Required>
            ...
            <div
                class="col-xl-6 col-md-6 col-sm-12 col-xs-12 d-flex flex-column justify-content-start align-items-left centrarContenido">
                    ...
                    <input type="text" class="form-control inputMiCuenta" id="txtEmail" name="txtEmail" Required>
        ...
        <div class="row justify-content-center animate__animated animate__fadeInUp animate__faster">
            <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <input type="password" class="form-control inputMiCuenta" id="txtContrasenia" name="txtContrasenia" >
        ...
        <div class="row justify-content-center mt-4 animate__animated animate__fadeInUp animate__faster">
            <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                <button type="submit" class="btn btn-outline-dark">Actualizar Ajustes</button>
            </div>
        </div>
    </form>
    <!-- Final del contenido -->
