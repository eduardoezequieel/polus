...
<body>
	...
	<div id="background">
		...
		<div id="form" class="paddingLados animate__animated animate__fadeInUp animate__faster">
			<div class="row">
				<div class="col-12">
					<h1 class="titulo2 text-center m-2">Creación del Primer Usuario</h1>
				</div>
			</div>
			<form action="/form" autocomplete="off" method="post" id="primerUso-form" enctype="multipart/form-data">
				<div class="justify-content-center row animate__animated animate__fadeInUp animate__faster">
					...
					<div
						...
						<div class="form-group mb-2">
							...
							<input type="text" maxlength="25" onchange="checkInputLetras('txtNombre')" class="form-control personalizacionPolus personalizacionPolusP"
								id="txtNombre" name="txtNombre" placeholder="Juan Armando">
						</div>
						<div class="form-group mb-2">
							...
							<input type="email" maxlength="80" onchange="checkCorreo('txtEmail')" class="form-control personalizacionPolus personalizacionPolusP mb-1"
								id="txtEmail" name="txtEmail" placeholder="ejemplo@mail.com">
						</div>
						<div class="form-group mb-2">
							...
							<input type="text" maxlength="25" onchange="checkAlfanumerico('txtUsuario')" class="form-control personalizacionPolus personalizacionPolusP mb-1"
								id="txtUsuario" name="txtUsuario" placeholder="usuario123">
						</div>
						...
						<div class="form-group mb-2">
							...
							type="password" class="form-control personalizacionPolus personalizacionPolusP mb-1"
							maxlength="15" onchange="checkContrasena('txtContraseña')" id="txtContraseña" name="txtContraseña" placeholder="Contraseña">
						</div>
					</div>
					<div
						...
						<div class="form-group mb-2">
							...
							<input maxlength="80" onchange="checkCorreo('txtConfirmarEmail')" type="email" class="form-control personalizacionPolus personalizacionPolusP mb-1"
					...
					<div
						...
						<div class="form-group mb-2">
							...
							<input maxlength="9" onchange="checkTelefono('txtTelefono')" type="text" class="form-control personalizacionPolus personalizacionPolusP mb-1"
								id="txtTelefono" name="txtTelefono" placeholder="0000-0000">
						</div>

						<div class="form-group mb-2">
							<label for="txtDireccion" class="mb-2 texto">Dirección:</label>
							<textarea maxlength="200" onchange="checkDireccion('txtDireccion')" class="form-control personalizacionPolus personalizacionPolusP mb-1" rows=3
				...
				<div class="row justify-content-center animate__animated animate__fadeInUp animate__faster m-2">
	...
	<script src="../../app/controllers/dashboard/primer_uso.js"></script>
