                ...
                <div
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="password" name="txtContraseñaActual" id="txtContraseñaActual"
                ...
                <div class="row justify-content-center mt-4">
						<div class="col-12 d-flex justify-content-center">
							<div class="form-check">
								<input id="chMostrarContraseña"  onChange="showHidePassword1('chMostrarContraseña', 'txtContraseñaActual', 'txtNuevaContraseña', 'txtConfirmarContraseña')" class="form-check-input" type="checkbox" value="" >
