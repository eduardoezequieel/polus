...
<html lang="es">
  ...
  <body>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center flex-column">
                    ...
                    <div class="form-group">
                            ...
                            <input type="password" name="txtContraseñaActual" id="txtContraseñaActual" class="form-control cajaTextoFormulario widthRegister" 
                            onchange="checkContrasena('txtContraseñaActual')" Required>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript" src="../../app/controllers/public/cambiar_clave.js"></script>
